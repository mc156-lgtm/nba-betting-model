"""
NBA Spread Prediction Model using XGBoost

This model predicts the point spread (margin of victory) for NBA games.
"""
...
class SpreadModel:
    ...
    def load_and_prepare_data(self):
        ...
        # Select feature columns (rolling averages and differences)
    ...
    def save_model(self, filepath='../../models/spread_model.pkl'):
    ...
    def load_model(self, filepath='../../models/spread_model.pkl'):
...
def main():
    ...
    print("NBA Spread Prediction Model")
    print("=" * 60)
